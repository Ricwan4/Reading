...
for iter = 1:maxIter
    ...
    %% check model %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    % 2021-06-03: ABC v0.78 - check if any bad variational parameters.
    badmodel = 0;
    ...
    if (badmodel)
      % if bad model, then break the loop later.
      do_break = 1;
      unstable = 1;  % mark as unstable
      L = -inf;      % invalidate LL
      
    else
      % otherwise, do the E-step
    ...
    % (otherwise break occurs after M-step)
